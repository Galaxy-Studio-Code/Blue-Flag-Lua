...
local toggled = false
Player_Function:add_toggle(
				'切换角色时自动补满血量、护甲和弹药', function()
					return toggled
				end, function(e)
					toggle = e
					if e then
						PlayerChangedCallback = menu.register_callback('OnPlayerChanged',
						                                               function(oldPlayer,
						                                                        newPlayer)
...
Weapon_Function:add_action('补满防弹衣', function()
	local items = { { 'MP_CHAR_ARMOUR_1_COUNT', 10 },
...
Vehicle_Function:add_toggle('进入载具时自动补满血量', function()
	...
	if e then
		VehicelChangedCallback = menu.register_callback('OnVehicleChanged',
		                                                function(oldVehicle,
		                                                         newVehicle)
...
vehicleHashes = { { '毕福 俱乐部', 2196012677 },
                  { '麦克斯韦 反社会', 1118611807 },
                  { '毕福 象鼻虫', 1644055914 },
                  { '卡林 半吊子', 1682114128 },
                  { '威尼 梦魇天威', 1239571361 },
                  ...
                  { '包洛坎 原野行者', 2844316578 },
                  { '卡林 半吊子', 3164157193 },
                  { '古罗帝 精力霸R/A', 1549126457 },
                  { '威尼 天威经典版', 931280609 },
                  { '贝飞特 哑剧', 3863274624 },
                  { '绝致 狂想曲', 841808271 },
                  { '威尼 科幻天威', 1537277726 },
                  { '威尼 末日天威', 628003514 },
                  { '古罗帝 精力霸300', 1429622905 },
                  { '丁卡 旅行家', 3950024287 },
                  { '丁卡 旅行家羽黑', 409049982 },
                  { '绝致 海致', 2485144969 },
                  { '福狮 英卡特', 3005245074 },
                  ...
                  { '卡林 入侵者', 886934177 },
                  { '威皮 史塔尼亚', 2817386317 },
                  { '亚班尼 初代改装版', 2254540506 },
                  { '贝飞特 长轴莎夫特 (装甲版)', 1922255844 },
                  { '亚班尼 皇霸天', 3609690755 },
                  { '敦追里 加长型礼车', 2333339779 },
                  { '雪佛 奔腾', 2400073108 },
                  { '奥北 密探S', 3050505892 },
                  { '埃努斯 至尊慧眼55', 906642318 },
                  { '敦追里 女皇', 4280472072 },
                  { '埃努斯 斯塔福德', 321186144 },
                  { '埃努斯 至尊慧眼 (装甲版)', 3690124666 },
                  { '埃努斯 至尊慧眼55 (装甲版)', 704435172 },
                  { '埃努斯 至尊慧眼', 2264796000 },
                  { '绝致 海致', 2487343317 },
                  { '绝致 统领', 2411098011 },
                  { '亚班尼 皇霸天', 3053254478 },
                  { '贝飞特 莎夫特V12 (装甲版)', 3406724313 },
                  { '福狮 守护星', 1373123368 },
                  { '赛柯尼 地层先锋', 1723137093 },
                  { '福狮 守护星HKR', 579912970 },
                  { '烈火马 钢骨灵车', 627094268 },
                  { '贝飞特 格伦戴尔改装版', 3381377750 },
                  { '贝飞特 格伦戴尔', 75131841 },
                  { '奥北 密探', 3286105550 },
                  { '亚班尼 初代', 3144368207 },
                  { '贝飞特 莎夫特', 3039514899 },
                  ...
                  { '兰帕达缇 诺瓦克', 2465530446 },
                  { '卡林 碧杰XL', 850565707 },
                  { '巨象 爱国者加长型', 3874056184 },
                  { '威皮 辐光', 2643899483 },
                  { '贝飞特 瑟雷诺', 1337041428 },
                  { '巨象 爱国者', 3486509883 },
                  { '奥北 小辣椒', 2136773105 },
                  { '绝致 屌王', 2519238556 },
                  { '悠游行者 行者LE', 1878062887 },
                  { '佩嘉西 奔牛', 3126015148 },
                  { '敦追里 追捕者XL', 3456868130 },
                  { '卡尼斯 陆上专家', 1221512915 },
                  { '悠游行者 行者', 3486135912 },
                  { '深水 FQ2', 3157435195 },
                  { '悠游行者 行者LE (装甲版)', 470404958 },
                  { '悠游行者 长轴行者LE (装甲版)', 666166960 },
                  { '威皮 争夺者', 683047626 },
                  { '悠游行者 行者', 142944341 },
                  { '亚班尼 骑兵', 2006918058 },
                  { '卡尼斯 炎魔', 914654722 },
                  ...
                  { '贝飞特 迪布达', 1177543287 },
                  { '皇霸天 哈拔尼禄', 884422927 },
                  { '悠游行者 长轴行者LE', 634118882 },
                  { '巨象 列兵', 4192631813 },
                  { '绝品 瑞巴 GTS', 83136452 },
                  { '卡尼斯 炎魔', 3546958660 },
                  { '冒险家 情欲猎手', 2751205197 },
                  { '贝飞特 XLS', 1203490606 },
                  { '贝飞特 XLS (装甲版)', 3862958888 },
                  { '埃努斯 亨特利S', 486987393 },
                  { '卡尼斯 陆上专家边境', 2484160806 },
                  { '贝飞特 迪布达', 3900892662 },
                  { '浪子 典范', 4289813342 },
                  { '卡林 普莱温', 1416471345 },
                  { '埃努斯 至尊慧眼敞篷版', 330661258 },
                  { '埃努斯 温莎敞篷版', 2364918497 },
                  { '绝品 卫士', 873639469 },
                  { '绝品 绝品天堂', 3172678083 },
                  { '绝品 先知', 3783366066 },
                  { '欧斯洛 胡狼', 3670438162 },
                  { '绝品 绝品天堂敞篷版', 3101863448 },
                  { '欧斯洛 F620', 3703357000 },
                  { '绝品 先知XS', 1348744438 },
                  { '绝品 卫士XS', 1349725314 },
                  { '埃努斯 温莎', 1581459400 },
                  { '兰帕达缇 恶龙GT', 4205676014 },
                  { '兰帕达缇 恶龙', 3903372712 },
                  { '英庞提 暗夜魅影', 2351681756 },
                  { '绝致 郁金', 1456744817 },
                  { '威皮 赫斯勒', 600450546 },
                  ...
                  { '英庞提 灭世暴徒', 777714999 },
                  { '威皮 克里克', 2728360112 },
                  { '威皮 公路霸者GTX', 3308022675 },
                  { '雪佛 斗牛士', 1507916787 },
                  { '威皮 梦魇凯撒大帝', 3539435063 },
                  { '非凡 艳妇黑鳍', 784565758 },
                  { '冒险家 红木烟业铁腕', 349315417 },
                  { '绝致 梦魇刺刑官', 2550461639 },
                  { '亚班尼 室女座', 3796912450 },
                  { '英庞提 灭世暴徒', 4067225593 },
                  { '英庞提 死亡公爵', 3968823444 },
                  { '亚班尼 闹鬼灵车', 2068293287 },
                  { '威皮 公路霸者GTT', 736672010 },
                  { '威皮 公路霸者', 80636076 },
                  { '威皮 爱利', 3027423925 },
                  { '绝致 瓦魔狮', 4245851645 },
                  { '英庞提 灭世暴徒2000', 941494461 },
                  { '亚班尼 风流海盗', 3612755468 },
                  { '威皮 尿汤啤公路霸者', 3379262425 },
                  { '敦追里 经典室女座', 16646064 },
                  { '威皮 公路霸者ASP', 426742808 },
                  { '绝致 活力够', 3469130167 },
                  { '绝致 武装坦帕', 3084515313 },
                  { '英庞提 比特公爵', 2134119907 },
                  { '亚班尼 风流海盗改装版', 3281516360 },
                  { '冒险家 铁腕地狱火', 1934384720 },
                  { '英庞提 公爵', 723973206 },
                  { '威皮 末日凯撒大帝', 444994115 },
                  { '威皮 科幻公路霸者', 2919906639 },
                  { '老爷卡车', 3627815886 },
                  { '赛乐斯特 异类', 1279262537 },
                  { '亚班尼 赫耳墨斯', 15219735 },
                  { '威皮 梦魇公路霸者', 3001042683 },
                  { '威皮 科幻凯撒大帝', 1637620610 },
                  { '绝致 巫毒', 523724515 },
                  { '绝致 科幻刺刑官', 2370166601 },
                  { '威拉德 宗派改装巨轮版', 2255212070 },
                  { '冒险家 铁腕经典改装版', 2172320429 },
                  { '威皮 梦魇大满贯皮卡', 1742022738 },
                  { '威皮 大满贯皮卡', 729783779 },
                  { '绝致 巫毒改装版', 2006667053 },
                  { '威皮 末日公路霸者', 3606777648 },
                  { '冒险家 铁腕经典版', 722226637 },
                  { '威皮 奇诺改装版', 2933279331 },
                  { '威皮 失落摩托帮大满贯皮卡', 833469436 },
                  { '威拉德 宗派', 2175389151 },
                  { '威皮 奇诺', 349605904 },
                  { '威皮 科幻大满贯皮卡', 373261600 },
                  { '绝致 吃得饱汉堡种马', 3893323758 },
                  { '威拉德 宗派改装版', 2504420315 },
                  { '绝致 坦帕', 972671128 },
                  { '威皮 刀锋', 3089165662 },
                  { '亚班尼 明日之星改装版', 1717532765 },
                  { '威皮 末日大满贯皮卡', 2233918197 },
                  { '绝致 末日刺刑官', 1009171724 },
                  { '绝致 军刀涡轮改装版', 223258115 },
                  { '绝致 漂移约塞米蒂', 1693751655 },
                  { '敦追里 经典室女座改装版', 3395457658 },
                  { '绝致 种马', 1923400478 },
                  { '绝致 刺刑官', 2198276962 },
                  { '威皮 佩优特古董赛车', 2490551588 },
                  { '浪子 疾速GT经典版', 2049897956 },
                  { '威皮 随行者 Mk 2', 2031587082 },
                  { '欧斯洛 炽焰', 159274291 },
                  { '古罗帝 远途经典版', 3312836369 },
                  { '兰帕达缇 卡斯科', 941800958 },
                  { '贝飞特 斯特林GT', 2728226064 },
                  { '绝致 龙卷风破烂老爷车', 2736567667 },
                  { '浪子 JB700', 1051415893 },
                  { '兰帕达缇 米其利GT', 1046206681 },
                  { '古罗帝 史汀格', 1545842587 },
                  { '欧斯洛 斯特龙伯格', 886810209 },
                  { '威皮 佩优特改装版', 1107404867 },
                  { '古罗帝 史汀格GT', 2196019706 },
                  { '古罗帝 GT500', 2215179066 },
                  { '卢恩 切布列克', 3306466016 },
                  { '卡林 190z', 838982985 },
                  { '绝致 龙卷风改装版', 2497353967 },
                  { '威尼 王朝', 310284501 },
                  { '特卢菲 Z型', 758895617 },
                  { '亚班尼 科学怪人', 3463132580 },
                  { '福狮 法加洛亚', 1617472902 },
                  ...
                  { '古罗帝 猎豹经典版', 223240013 },
                  { '浪子 JB700W', 394110044 },
                  { '佩嘉西 炼狱魔经典版', 2889029532 },
                  { '绝致 龙卷风', 464687292 },
                  { '亚班尼 明日之星', 2170765704 },
                  { '佩嘉西 门罗', 3861591579 },
                  { '亚班尼 罗斯福勇气', 3692679425 },
                  { '佩嘉西 斗牛', 1504306544 },
                  { '爱尼仕 萨维斯特拉', 903794909 },
                  { '绝致 龙卷风', 2261744861 },
                  { '绝致 龙卷风', 1531094468 },
                  ...
                  { '丁卡 弄臣', 2997294755 },
                  { '卡林 福多', 2016857647 },
                  { '卡林 骷髅马 (装甲版)', 410882957 },
                  { '丁卡 冲冲猴旅行家', 3703315515 },
                  { '非凡 艳妇D10', 2566281822 },
                  { '欧斯洛 蝗虫', 3353694737 },
                  { '爱尼仕 梦魇ZR380', 2816263004 },
                  { '亚班尼 阿尔法', 767087018 },
                  { '古罗帝 野兽GTS', 1274868363 },
                  { '海岬 变色龙', 544021352 },
                  { '冒险家 女妖', 3253274834 },
                  { '爱尼仕 挽歌怀旧改装版', 196747873 },
                  { '丁卡 小型旅行家', 1039032026 },
                  { '浪子 幽鬼', 1886268224 },
                  { '非凡 艳妇', 108773431 },
                  { '浪子 幽鬼改装版', 1074745671 },
                  ...
                  { '奥北 奥姆尼斯', 3517794615 },
                  { '傲弗拉 明日', 3162245632 },
                  { '卡林 卡利科GTF', 3101054893 },
                  { '欧斯洛 扼喉', 4086055493 },
                  { '卡林 王者RS经典版', 4003946083 },
                  { '丁卡 弄臣经典版', 4080061290 },
                  { '海岬 拉斯顿', 719660200 },
                  { '麦霸子 半影使者FF', 3663644634 },
                  { '古罗帝 义塔力RSX', 3145241962 },
                  { '卡林 福多GTX', 2787736776 },
                  { '奥北 9F敞篷版', 2833484545 },
                  { '绝品 反叛者', 3884762073 },
                  { '欧斯洛 山猫', 482197771 },
                  { '贝飞特 飞特者', 2299640309 },
                  { '威皮 闪电GT', 3035832600 },
                  { '贝飞特 莎夫特V12', 2809443750 },
                  { '爱尼仕 科幻ZR380', 3188846534 },
                  { '兰帕达缇 逐波雷厉', 1887331236 },
                  { '浪子 疾速GT', 1737773231 },
                  { '卡林 骷髅马', 2922118804 },
                  { '贝飞特 撞击GT', 3787471536 },
                  { '绝品 塞弗', 1755697647 },
                  ...
                  { '浪子 疾速GT', 2360515092 },
                  { '绝致 漂移坦帕', 3223586949 },
                  { '兰帕达缇 沸洛雷GT', 3205927392 },
                  { '旋风 雷电', 2765724541 },
                  { '浪子 马萨克罗 (赛车)', 3663206819 },
                  { '浪子 马萨克罗', 4152024626 },
                  { '古罗帝 义塔力GTO', 3963499524 },
                  { '贝飞特 速雷', 384071873 },
                  { '爱尼仕 雷姆斯', 1377217886 },
                  { '爱尼仕 ZR350', 2436313176 },
                  { '菲斯特 陆上彗星怀旧改装版', 2272483501 },
                  { '绝品 卫士经典版', 1104234922 },
                  { '菲斯特 陆上彗星SR', 661493923 },
                  { '浪子 柒-70', 2537130571 },
                  { '冒险家 迷失者', 1102544804 },
                  { '亚班尼 V-STR', 1456336509 },
                  { '皇霸天 韦柯特', 2754593701 },
                  { '爱尼仕 挽歌RH8', 3728579874 },
                  { '兰帕达缇 科莫达', 3460613305 },
                  { '古罗帝 汗血宝马', 2072687711 },
                  { '丁卡 RT3000', 3842363289 },
                  { '丁卡 微托经典版', 3437611258 },
                  { '麦霸子 半影使者', 3917501776 },
                  { '卡林 王者经典版', 872704284 },
                  { '贝飞特 长轴莎夫特', 1489967196 },
                  { '绝致 燃轨军刀', 1115909093 },
                  { '冒险家 猛牛', 3990165190 },
                  { '赛乐斯特 眩光', 499169875 },
                  { '爱尼仕 欧洲', 2038480341 },
                  { '奥北 9F', 1032823388 }, { '威皮 GB200', 1909189272 },
                  { '埃努斯 帕拉贡R', 3847255899 },
                  { '丁卡 弄臣 (赛车)', 3188613414 },
                  { '威尼 天威跑车版', 1854776567 },
                  { '冒险家 猛牛S', 736902334 },
                  { '丁卡 斯国一', 987469656 },
                  { '菲斯特 霓虹', 2445973230 },
                  { '埃努斯 帕拉贡R (装甲版)', 1416466158 },
                  { '维沙 尼欧', 2674840994 },
                  { '菲斯特 陆上彗星S2', 2568944644 },
                  { '爱尼仕 末日ZR380', 540101442 },
                  { '菲斯特 彗星狩猎者', 1561920505 },
                  { '丁卡 微托现代版', 2802050217 },
                  { '佩嘉西 佐路索', 3612858749 },
                  { '培罗 义塔力GTB', 2246633323 },
                  { '义警', 3052358707 },
                  { '佩嘉西 奥西里斯', 1987142870 },
                  { '培罗 泰勒斯', 2067820283 },
                  { '欧斯洛 穿刺者', 2536829930 },
                  ...
                  { '佩嘉西 狂牛', 338562499 },
                  { '特卢菲 特拉克斯', 1044193113 },
                  { '旋风 狂雷', 2672523198 }, { '培罗 T20', 1663218586 },
                  { '威皮 子弹', 2598821281 },
                  { '菲斯特 811', 2465164804 },
                  { '冒险家 女妖900R', 633712403 },
                  { '特卢菲 尼罗改装版', 1093792632 },
                  { '佩嘉西 炼狱魔', 418536135 },
                  { '佩嘉西 泰泽拉克', 1031562256 },
                  { '傲弗拉 本质XXR', 2174267100 },
                  { '普林西比 蹂躏者8', 1591739866 },
                  { '特卢菲 灵蛇', 3078201489 },
                  { '威皮 FMJ', 1426219628 },
                  { '傲弗拉 统治者', 3918533058 },
                  { '培罗 艾梅鲁斯', 1323778901 },
                  { '培罗 义塔力GTB改装版', 3812247419 },
                  { '卡林 王者RS', 3999278268 },
                  { '浪子 瓦格纳', 1939284556 },
                  { '贝飞特 武夫', 3630826055 },
                  { '佩嘉西 死神', 234062309 },
                  { '皇霸天 ETR1', 819197656 }, { '培罗 GP1', 1234311532 },
                  { '爱尼仕 S80RR', 3970348707 },
                  { '绝品 SC1', 1352136073 },
                  { '古罗帝 远途R', 408192225 },
                  { '特卢菲 尼罗', 1034187331 },
                  { '雪佛 泰斑', 3160260734 },
                  ...
                  { '古罗帝 狂热', 960812448 },
                  { '古罗帝 幻象', 3296789504 },
                  { '古罗帝 X80原型', 2123327359 },
                  { '旋风 飓风', 1392481335 },
                  { '旋风 火箭狂雷', 989294410 },
                  { '欧斯洛 XA-21', 917809321 },
                  { '爱尼仕 RE-7B', 3062131285 },
                  { '诗津 亵渎者', 822018448 },
                  { '西部 科幻丧尸', 2482017624 },
                  { '麦霸子 曼切兹侦查', 1086534307 },
                  { '西部 梦魇丧尸', 2920466844 },
                  { '丁卡 街头恶魔', 1672195559 },
                  { '西部 石像鬼', 741090084 },
                  { '丁卡 猛冲', 1836027715 },
                  { '麦霸子 桑切斯', 2841686334 },
                  { '诗津 PCJ600', 3385765638 }, { 'LCC 创新', 4135840458 },
                  { '佩嘉西 801巴提', 4180675781 },
                  { '佩嘉西 漩涡', 3685342204 },
                  { '西部 恶狼克星', 3676349299 },
                  { '丁卡 双T', 2623969160 },
                  { '西部 恶魔', 2890830793 },
                  { '佩嘉西 费甲欧摩登版', 3005788552 },
                  { '佩嘉西 801RR巴提', 3403504941 },
                  { '佩嘉西 暴君Mk2', 2069146067 },
                  { 'LCC 迷魅光轮', 301427732 },
                  { '丁卡 恩斗罗', 1753414259 },
                  { '普林西比 雷克卓', 640818791 },
                  { '佩嘉西 FCR1000改装版', 3537231886 },
                  { '佩嘉西 爱时吉', 2035069708 },
                  { '长崎 斯特德', 301304410 },
                  { '佩嘉西 暴君', 884483972 },
                  { '西部 狂暴火箭', 916547552 },
                  { '佩嘉西 费甲欧', 55628203 },
                  { '西部 恶魔', 2006142190 },
                  { '佩嘉西 FCR1000', 627535535 },
                  { '诗津 白鸟竞速版', 4039289119 },
                  { '长崎 碳纤RS型', 11251904 },
                  { '西部 鞭尸者', 3285698347 },
                  { '诗津 白鸟', 1265391242 }, { '长崎 BF400', 86520421 },
                  { '长崎 圣太郎', 3889340782 },
                  { '普林西比 蒂雅布萝', 4055125828 },
                  { '普林西比 蒂雅布萝改装版', 1790834270 },
                  { '麦霸子 桑切斯 (涂装版)', 788045382 },
                  { '西部 高潮', 390201602 },
                  { '普林西比 复仇女神', 3660088182 },
                  { '西部 破烂摩托车', 1873600305 },
                  { '西部 末日丧尸', 4267640610 },
                  { '西部 驮兽', 2154536131 },
                  { '佩嘉西 费甲欧现代版', 2452219115 },
                  { '麦霸子 曼切兹', 2771538552 },
                  { '丁卡 审判者', 2941886209 },
                  { '西部 碎尸者', 3724934023 },
                  { '西部 君主', 743478836 },
                  { '西部 夜刃', 2688780135 },
                  { 'LCC 阿瓦鲁斯', 2179174271 },
                  { '诗津 威德', 4154065143 }, { 'LCC 圣驹', 1491277511 },
                  { '佩嘉西 恶霸', 3401388520 },
                  { '长崎 奇美拉', 6774487 },
                  { '卡林 铁尼高', 2198148358 },
                  { '毕福 沙丘征服者', 1126868326 },
                  { '长崎 烈焰救生型', 4246935337 },
                  { '长崎 水陆烈焰骑士', 2704629607 },
                  { '卡林 叛逆男女', 2249373259 },
                  { '贝飞特 科幻捍士', 2600885406 },
                  { '冒险家 越野游侠', 1770332643 },
                  { '威皮 卡拉卡拉', 1254014755 },
                  { 'HVY 夜鲨', 433954513 }, { '斜面魔宝', 3467805257 },
                  { '卡尼斯 卡拉哈里', 92612664 },
                  { '贝飞特 迪布达6x6', 3057713523 },
                  { 'HVY 叛乱分子皮卡', 2434067162 },
                  { '毕福 沙丘FAV', 1897744184 },
                  { '威皮 大脚霸王SWB', 989381445 },
                  { 'HVY 叛乱分子皮卡改装版', 2370534026 },
                  { '太空码头工', 534258863 },
                  { '贝飞特 末日捍士', 668439077 },
                  { '卡尼斯 自由攀登者', 4240635011 },
                  { 'HVY 叛乱分子', 2071877360 },
                  { '旋风 斗殴者', 2815302597 },
                  { '绝致 科幻布鲁图斯', 2403970600 },
                  { '长崎 火辣烈焰', 3025077634 },
                  { '毕福 必浮塔', 3945366167 },
                  { '绝致 蓝彻XL', 1933662059 },
                  { '长崎 街头烈焰', 3854198872 },
                  { '威皮 大脚霸王XL', 3105951696 },
                  { '冒险家 末日大脚怪', 1721676810 },
                  { '卡尼斯 卡马乔', 4173521127 },
                  { '绝致 末日布鲁图斯', 2139203625 },
                  { '长崎 不法之徒', 408825843 },
                  { '丁卡 维鲁斯', 298565713 },
                  { '威皮 利雅塔', 2762269779 },
                  { '卡林 叛逆男女生锈版', 3087195462 },
                  { '卡林 埃弗伦', 2538945576 },
                  { '毕福 沙丘魔宝', 2633113103 },
                  { '卡尼斯 万用行者', 2859047862 },
                  { '威皮 沙漠突击', 3631668194 },
                  { 'RC匪徒', 4008920556 },
                  { '威皮 解放者', 3449006043 },
                  { '绝致 梦魇布鲁图斯', 2038858402 },
                  { '绝致 约塞米蒂蓝彻', 67753863 },
                  { '卢恩 炸吧', 1284356689 },
                  { 'HVY 威胁者', 2044532910 },
                  { '威皮 越野卡车', 101905590 },
                  { '卡林 水陆铁尼高', 1180875963 },
                  { '冒险家 梦魇大脚怪', 3579220348 },
                  { '爱尼仕 恶人', 3932816511 },
                  { '雪佛 马绍尔', 1233534620 },
                  { '贝飞特 梦魇捍士', 2252616474 },
                  { '斜面魔宝', 3982671785 },
                  ...
                  { '长崎 烈焰', 2166734073 },
                  { '绝致 蓝彻XL', 1645267888 },
                  { '威皮 卡拉卡拉四驱车', 2945871676 },
                  { '卡林 铁尼高改装版', 1356124575 },
                  { 'MTL 平板拖车', 1353720154 },
                  { '码头装卸车', 444583674 },
                  { 'HVY 混凝土搅拌车', 475220373 },
                  { 'HVY 矿石搬运车', 2164484578 },
                  { '工地倾卸车', 3347205726 },
                  { '威皮 守护者', 2186977100 },
                  { 'HVY 钻洞机', 3288047904 },
                  { '威霸 工地倾卸车', 48339065 },
                  { '乔氏 砂通天', 2589662668 },
                  { 'HVY 混凝土搅拌车', 3510150843 },
                  { 'HVY 推土机', 1886712733 }, { '拖车', 3417488910 },
                  { '拖车', 1019737494 },
                  { '斯坦利 农耕机', 2218488798 },
                  { '拖车', 2154757102 }, { '拖车', 2942498482 },
                  { '拖车', 2236089197 }, { '拖车', 3564062519 },
                  { '拖车', 2524324030 }, { '拖车', 712162987 },
                  { '公共事业卡车', 516990260 }, { '拖车', 2016027501 },
                  { '码头拖车', 3410276810 },
                  { '高尔夫球车', 1147287684 },
                  { '机场牵引车', 3448987385 },
                  { '高尔夫球车', 3525819835 },
                  { '威皮 大满贯卡车', 3249056020 },
                  { '公共事业卡车', 887537515 },
                  { '草捆拖车', 3895125590 }, { 'HVY 叉车', 1491375716 },
                  { '拖车', 390902130 },
                  { '斯坦利 农耕机', 1445631933 },
                  { '拖车', 1956216962 }, { '行李拖车', 1560980623 },
                  { '拖船', 524108981 }, { '老式拖拉机', 1641462412 },
                  { '威皮 沙德勒', 3695398481 },
                  { '公共事业卡车', 2132890591 },
                  { '拖车', 3517691494 }, { '威皮 沙德勒', 734217681 },
                  { '拖吊车', 3852654278 }, { '军用拖车', 2657817814 },
                  { '拖车', 1784254509 }, { '军用拖车', 2818520053 },
                  { '拖车', 2078290630 },
                  { '机动作战中心', 1502869817 },
                  { '军用拖车', 3087536137 }, { '拖车', 2715434129 },
                  { '拖吊车', 2971866336 }, { '拖车', 356391690 },
                  { '拖车', 2091594960 }, { '割草车', 1783355638 },
                  { '拖车', 3194418602 }, { '高尔夫球车', 3757070668 },
                  { '废五金回收车', 2594165727 },
                  { '威皮 劲速改装版', 219613597 },
                  { '冒险家 野牛', 4278019151 },
                  { '冒险家 澜波改装版', 1475773103 },
                  { '威霸 小马', 943752001 },
                  { '装甲版厢村', 682434785 },
                  { '冒险家 澜波', 1162065741 }, { '厢村', 4061868990 },
                  { '冒险家 天堂', 1488164764 },
                  { '威霸 厢村', 2307837162 },
                  { '玉米饼餐车', 1951180813 },
                  { '赛柯尼 安旅者', 4174679674 },
                  ...
                  { '威皮 雄猫XL', 1069929536 },
                  { '毕福 乘风', 699456151 },
                  { '威皮 迷你厢型车改装版', 3168702960 },
                  { '冒险家 游侠经典四驱车', 1802742206 },
                  { '冒险家 游侠经典版', 1026149675 },
                  { '绝致 屌客', 893081117 },
                  { '威霸 露营车', 1876516712 },
                  { '绝致 屌客', 2551651283 },
                  { '冒险家 澜波', 2518351607 },
                  ...
                  { '威霸 小马', 4175309224 },
                  { '威皮 迷你厢型车', 3984502180 },
                  { '极限耐力竞速自行车', 3061159916 },
                  { '惠比特竞速自行车', 1127861609 },
                  { 'BMX', 1131912276 },
                  { '特莱赛可竞速自行车', 3894672200 },
                  { '先驱者', 4108429845 }, { '费斯特', 3458454463 },
                  { '巡航者', 448402357 },
                  { '丁卡 水上侯爵', 3251507587 },
                  { '长崎 武装小艇', 3314393930 },
                  { '佩嘉西 飙速', 231083307 }, { '潜水艇', 771711535 },
                  { '佩嘉西 飙速', 437538602 },
                  { '长崎 小艇', 276773164 },
                  { '兰帕达缇 公牛', 1070967343 },
                  { '兰帕达缇 公牛', 908897389 },
                  ...
                  { '诗津 烈阳号', 1448677353 },
                  { '诗津 烈阳号', 290013743 },
                  { '水上枭雄 海鲨摩托艇', 3264692260 },
                  { '长崎 小艇', 1033245328 },
                  { '长崎 小艇', 509498602 }, { '拖船', 2194326579 },
                  { '水上枭雄 海鲨摩托艇', 3678636260 },
                  { '库尔兹31巡逻艇', 4018222598 },
                  { '水上枭雄 海鲨摩托艇', 3983945033 },
                  { '长崎 小艇', 867467158 },
                  { '诗津 长鳍', 1861786828 },
                  { '诗津 极限快艇', 861409633 },
                  { '卢恩 虎鲸', 1336872304 },
                  ...
                  { '诗津 思快乐快艇', 400514754 },
                  { '海怪', 3228633070 },
                  { '白金汉 超级沃利托碳纤版', 2623428164 },
                  { '穿梭者', 1949211328 },
                  { '运兵直升机', 1621617168 },
                  { '吊挂直升机', 1044954915 },
                  { '白金汉 斯威夫特', 3955379698 },
                  { '歼灭者', 837858166 }, { '运兵直升机', 2025593404 },
                  { '白金汉 超级沃利托', 710198397 },
                  { '野蛮人', 4212341271 }, { '麻雀', 1593933419 },
                  { '秃鹰直升机', 745926877 },
                  { '警用小蛮牛', 353883353 },
                  { '运兵直升机', 4244420235 },
                  { '秃鹰攻击直升机', 788747387 },
                  { '麻雀', 1229411063 }, { '穿梭者', 744705981 },
                  { '歼灭者隐形版', 295054921 }, { '海雀', 3568198617 },
                  { '女武神MOD.0', 1543134283 }, { '阿库拉', 1181327175 },
                  { '白金汉 斯威夫特豪华版', 1075432268 },
                  { '白金汉 弗拉图斯', 2449479409 },
                  { '运兵直升机', 1394036463 },
                  { 'FH-1猎杀者', 4252008158 }, { '女武神', 2694714877 },
                  { '小蛮牛', 2634305738 },
                  { '长崎 浩劫者', 2310691317 },
                  { '梅杜莎', 2621610858 }, { '梅杜莎5座', 1077420264 },
                  { '西部 恶徒', 3319621991 },
                  { 'V-65莫洛托克', 1565978651 },
                  { 'B-11突击部队', 1692272545 },
                  { '巨象 复仇者', 2176659152 },
                  { '白金汉 夏玛尔客机', 3080461301 },
                  { '货机', 368211810 }, { '洒药机', 970356638 },
                  { '白金汉 军用喷气机', 165154707 },
                  { '原子飞艇', 4143991942 },
                  { '希罗飞艇', 3681241380 },
                  { '白金汉 霍华德NX-25', 3287439187 },
                  { '泰坦号', 1981688531 }, { 'P-996天煞', 3013282534 },
                  { '飞艇', 3987008919 },
                  { '白金汉 威斯特拉', 1341619767 },
                  { '西部 海风', 3902291871 },
                  { '巨象 图拉', 1043222410 },
                  { '白金汉 乐梭豪华版', 3080673438 },
                  { '天行巨兽', 2548391185 },
                  { 'RM-10邦布什卡', 4262088844 },
                  { '巨象 嘟嘟鸟', 3393804037 },
                  { '白金汉 灵气号', 2999939664 },
                  { 'RO-86阿尔科诺斯特', 3929093893 },
                  { 'P-45诺克塔', 1036591958 },
                  { '白金汉 狂焰', 2908775872 },
                  { '沃拉托', 447548909 }, { '巨象 复仇者', 408970549 },
                  { '西部 雀鹰', 1824333165 },
                  { '白金汉 乐梭', 621481054 },
                  { '巨象 九头蛇', 970385471 },
                  { 'LF-22星椋', 2594093022 },
                  { '白金汉 阿尔法-Z1', 2771347558 },
                  { '古邦800', 3650256867 },
                  { '巨象 莫古尔', 3545667823 }, { '野鸭', 2172210288 },
                  { '喷气机', 1058115860 }, { '长崎 鸿毛', 2531412055 },
                  { '垃圾大王', 3039269212 }, { '巴士', 3581397346 },
                  { '出租车', 3338918751 }, { '观光巴士', 1941029835 },
                  { '白狗巴士', 2222034228 }, { 'MTL 沙丘', 2191146052 },
                  { 'MTL 布里凯德', 3989239879 },
                  { '音乐节巴士', 345756458 },
                  { '租用穿梭巴士', 3196165219 },
                  { 'MTL 拓荒者', 2382949506 },
                  { '机场巴士', 1283517198 },
                  { '垃圾大王', 1917016601 }, { 'FIB', 1127131465 },
                  { '警长座车', 2611638396 }, { 'FIB', 2647026068 },
                  { '警用公路巡逻车', 2515846680 },
                  { '警用巡逻车', 1912215274 },
                  { '警用运输车', 456714581 },
                  { '绝致 沙滩急救车', 469291905 },
                  { '无标识巡航者', 2321795001 },
                  { '警长SUV', 1922257928 }, { '防暴车', 2601952180 },
                  { '警用巡逻车', 2667966721 },
                  { '警用巡逻车', 2046537925 },
                  { '警用防暴车', 3089277354 },
                  { 'MTL 消防车', 1938952078 }, { '救护车', 1171614426 },
                  { '警用蓝彻', 2758042359 },
                  { '国家公园警用车', 741586030 },
                  { '警用摩托车', 4260343491 },
                  { '移监巴士', 2287941233 }, { '维泰尔', 2014313426 },
                  { '入侵与说服 坦克', 3040635986 },
                  { '犀牛坦克', 782665360 },
                  { '卡尼斯 傲世铁骑', 321739290 },
                  { '地霸王', 630371791 }, { '地霸王', 3471458123 },
                  { '巨象 推进者', 1489874736 },
                  { '冒险家 半履战车', 4262731174 },
                  { 'HVY APC', 562680400 },
                  { 'HVY 科幻圣甲虫', 1542143200 },
                  { 'HVY 末日圣甲虫', 3147997943 },
                  { 'TM-02可汗贾利', 2859440138 },
                  { '巴拉杰', 4081974053 },
                  { '切尔诺伯格', 3602674979 },
                  { 'HVY 拖车型地霸王', 1074326203 },
                  { 'HVY 梦魇圣甲虫', 3715219435 },
                  { '冯·伏厄 防空拖车', 2413121211 },
                  { '乔氏 魅影', 2157618379 },
                  { '乔氏 搬运者改装版', 387748548 },
                  { 'MTL 车辆运送车', 569305213 },
                  { '威皮 班森', 2053223216 },
                  { '麦霸子 猛骡改装版', 1945374990 },
                  { 'MTL 末日地狱犬', 3493417227 },
                  { '乔氏 搬运者', 1518533038 },
                  { '威霸 拦截者', 4080511798 },
                  { '乔氏 魅影改装版', 177270108 },
                  { '贝飞特 恐霸', 2306538597 },
                  ...
                  { 'HVY 倾卸车', 850991848 },
                  { '乔氏 尖锥魅影', 2645431192 },
                  { 'MTL 梦魇地狱犬', 1909700336 },
                  { '威霸 拦截者', 1747439474 },
                  { 'MTL 跑德改装版', 1653666139 },
                  { 'MTL 跑德', 2112052861 }, { '货运列车', 184361638 },
                  { '货运列车', 642617954 }, { '缆车', 3334677549 },
                  { '货运列车', 586013744 }, { '货运列车', 920453016 },
                  { '货运列车', 3186376089 },
                  { '货运列车', 1030400667 }, { '货运列车', 240201337 },
                  { '货运列车', 868868440 },
                  { '贝飞特 BR8', 1492612435 }, { '培罗 PR4', 340154634 },
                  { '绝致 DR1', 1181339704 }, { '欧斯洛 R88', 2334210311 },
                  { '菲斯特 宇航', 629969764 },
                  { '绝致 屌王3600LX', 4033620423 },
                  { '威皮 游侠改装版', 1486521356 },
                  { '悠游行者 行者ST', 359875117 },
                  { '埃努斯 神灵', 1532171089 },
                  { '兰帕达缇 五千', 2767531027 },
                  { '浪子 冠军', 3379732821 },
                  { '麦霸子 猛骡', 1343932732 },
                  { '巨象 爱国者军用版', 3624880708 },
                  { '菲斯特 陆上彗星S2敞篷版', 1141395928 },
                  { '傲弗拉 捷诺', 655665811 },
                  { '西部 里弗', 1993851908 },
                  { '佩嘉西 伊格纳斯', 2850852987 },
                  { '长崎 信奴比', 1353120668 },
                  { '冒险家 猛牛STX', 3675036420 },
                  { '奥北 爱瓦根', 662793086 },
                  { '埃努斯 吉伯力', 461465043 } }
...
local UKN_KBBL_TELE = Teleport_Function:add_submenu(
				                      'Kenny\'s Backyard Boogie 专辑')
...
Recovery_Function:add_action('移除收支差', function()
	...
	if a > b then
		local m = a - b
		stat_set_int('MP0_MONEY_EARN_JOBSHARED', true,
		             stats.get_int(CurrentMP('MONEY_EARN_JOBSHARED')) + m)
	end
end)
-- Misc Function
...
local CASINO_PRESETS = CASINO_HEIST:add_submenu(
				                       '预设 (进入分红界面后也须点击一次)')
...
local DOOMS_PRESETS = DOOMS_HEIST:add_submenu(
				                      '预设 (进入分红界面后也须点击一次)')
local DDHEIST_PLYR_MANAGER = DOOMS_HEIST:add_submenu('玩家分红')
local TELEPORT_DOOMS = DOOMS_HEIST:add_submenu('传送地点')
--
local CLASSIC_HEISTS = Heist_Control:add_submenu(
				                       '公寓老抢劫 (进入分红界面后也须点击一次)')
local CLASSIC_CUT = CLASSIC_HEISTS:add_submenu(
				                    '你的分红 (作为房主时使用)')
--
local TH_CONTRACT = Heist_Control:add_submenu(
				                    '事务所合约 (进入分红界面后也须点击一次)')
local LS_ROBBERY = Heist_Control:add_submenu(
				                   '改装铺合约 (进入分红界面后也须点击一次)')
...
HI_Vehicle:add_action('查询最常使用的接近载具', function()
	...
	HI_Vehicle_Result:add_action('你选择了' .. SUB .. stat_result .. URL,
	                             function()
	end)
	HI_Vehicle_Result:add_action('你选择了' .. AKT .. stat_result_0 .. URL,
	                             function()
	end)
	HI_Vehicle_Result:add_action('你选择了' .. VEL .. stat_result_1 .. URL,
	                             function()
	end)
	HI_Vehicle_Result:add_action('你选择了' .. STA .. stat_result_2 .. URL,
	                             function()
	end)
	HI_Vehicle_Result:add_action('你选择了' .. KUT .. stat_result_3 .. URL,
	                             function()
	end)
	HI_Vehicle_Result:add_action('你选择了' .. LOG .. stat_result_4 .. URL,
	                             function()
	end)
end)
...
HI_PRIMARY:add_action('查询抢劫的主要目标次数', function()
	...
	HI_PRIMARY_Result:add_action('你选择了' .. PAN .. Answer_0 .. URL,
	                             function()
	end)
	HI_PRIMARY_Result:add_action('你选择了' .. MAZ .. Answer_1 .. URL,
	                             function()
	end)
	HI_PRIMARY_Result:add_action('你选择了' .. PDD .. Answer_2 .. URL,
	                             function()
	end)
	HI_PRIMARY_Result:add_action('你选择了' .. BON .. Answer_3 .. URL,
	                             function()
	end)
	HI_PRIMARY_Result:add_action('你选择了' .. NCK .. Answer_4 .. URL,
	                             function()
	end)
	HI_PRIMARY_Result:add_action('你选择了' .. TQL .. Answer_5 .. URL,
	                             function()
	end)
end)
...
HI_Complete:add_action('查询完成的佩里克岛抢劫次数', function()
	...
	HI_Complete_Result:add_action(
					'你完成了佩里克岛抢劫' .. stat_result_5 .. URL, function()
					end)
end)
...
TELEPORT_QL:add_action('海洋 :: 安全位置', function()
	if not localplayer:is_in_vehicle() then
		...
		localplayer:get_current_vehicle():set_position(
						vector3(4905.050, -6339.578, -89.830))
	end
end)
--
...
TELEPORT_DOOMS:add_action('设施 :: 抢劫计划室', function()
	...
	localplayer:set_position(vector3(343.97885131836, 4864.76953125,
	                                 -60.004898071289))
end)
...
do
	...
	HE_about_info:add_action(
					'风险自控, 封号了可以告知你使用的功能', function()
					end)
end
...
do
	local QUICK_SET_ANY =
       ...
       { 'H4LOOT_PAINT_SCOPED', 0 }, { 'H4CNF_TARGET', 5 },
       { 'H4CNF_WEAPONS', 5 }, { 'H4_MISSIONS', -1 }, { 'H4_PROGRESS', 126823 } }
	QUICK_PRST:add_action(
					'加载快速预设 (不拿次要目标,可拿保险箱)', function()
...
do
	local WEAKLY_QUICK =
       ...
       { 'H4LOOT_GOLD_I_SCOPED', 0 }, { 'H4LOOT_GOLD_C_SCOPED', 0 },
       { 'H4LOOT_PAINT_SCOPED', 0 }, { 'H4CNF_TARGET', 5 },
       { 'H4CNF_WEAPONS', 4 }, { 'H4_MISSIONS', -1 }, { 'H4_PROGRESS', 126823 } }
	WEEKLY_PRESET:add_action(
					'加载活动周快速预设 (不拿次要目标,可拿保险箱)',
					function()
...
do
	local AUTOMATED_1P_TARGET_5 =
					{ { 'PROSTITUTES_FREQUENTE', 100 }, -- I know horny boy, this has nothing to do with Cayo, but it is just a protection to avoid bugs
       { 'H4CNF_TARGET', 5 }, { 'H4LOOT_CASH_I', 8128 },
       { 'H4LOOT_CASH_I_SCOPED', 8128 }, { 'H4LOOT_CASH_C', 0 },
       { 'H4LOOT_CASH_C_SCOPED', 0 }, { 'H4LOOT_COKE_I', 63 },
       { 'H4LOOT_COKE_I_SCOPED', 63 }, { 'H4LOOT_COKE_C', 22 },
       { 'H4LOOT_COKE_C_SCOPED', 22 }, { 'H4LOOT_GOLD_I', 0 },
       { 'H4LOOT_GOLD_I_SCOPED', 0 }, { 'H4LOOT_GOLD_C', 168 },
       { 'H4LOOT_GOLD_C_SCOPED', 168 }, { 'H4LOOT_WEED_I', 16769024 },
       { 'H4LOOT_WEED_I_SCOPED', 16769024 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 207386 },
       { 'H4LOOT_COKE_V', 414772 }, { 'H4LOOT_GOLD_V', 553029 },
       { 'H4LOOT_PAINT_V', 414772 }, { 'H4LOOT_WEED_V', 331818 }, --
					{ 'H4_PROGRESS', 126823 }, { 'H4CNF_BS_GEN', -1 }, { 'H4CNF_BS_ENTR', -1 },
       { 'H4CNF_BS_ABIL', -1 }, { 'H4CNF_WEP_DISRP', 3 },
       { 'H4CNF_ARM_DISRP', 3 }, { 'H4CNF_HEL_DISRP', 3 },
       { 'H4CNF_APPROACH', -1 } }
	local AUTOMATED_1P_TARGET_5_A =
					{ { 'PROSTITUTES_FREQUENTE', 100 }, -- I know horny boy, this has nothing to do with Cayo, but it is just a protection to avoid bugs
       { 'H4CNF_BOLTCUT', 4424 }, { 'H4CNF_UNIFORM', 5256 },
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	AUTOMATED_SOLO:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #AUTOMATED_1P_TARGET_5_A do
							stat_set_int(AUTOMATED_1P_TARGET_5_A[i][1], true,
							             AUTOMATED_1P_TARGET_5_A[i][2])
						end
						for i = 1, #AUTOMATED_1P_TARGET_5 do
							stat_set_int(AUTOMATED_1P_TARGET_5[i][1], true,
							             AUTOMATED_1P_TARGET_5[i][2])
						end
...
do
	local CAYO_SOLO_AUTO_TARGET_3 =
					{ { 'PROSTITUTES_FREQUENTE', 100 }, -- I know horny boy, this has nothing to do with Cayo, but it is just a protection to avoid bugs
       { 'H4CNF_TARGET', 3 }, { 'H4LOOT_CASH_I', 63 },
       { 'H4LOOT_CASH_I_SCOPED', 63 }, { 'H4LOOT_CASH_C', 0 },
       { 'H4LOOT_CASH_C_SCOPED', 0 }, { 'H4LOOT_COKE_I', 16769024 },
       { 'H4LOOT_COKE_I_SCOPED', 16769024 }, { 'H4LOOT_COKE_C', 22 },
       { 'H4LOOT_COKE_C_SCOPED', 22 }, { 'H4LOOT_GOLD_I', 0 },
       { 'H4LOOT_GOLD_I_SCOPED', 0 }, { 'H4LOOT_GOLD_C', 168 },
       { 'H4LOOT_GOLD_C_SCOPED', 168 }, { 'H4LOOT_WEED_I', 8128 },
       { 'H4LOOT_WEED_I_SCOPED', 8128 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 357386 },
       { 'H4LOOT_COKE_V', 714772 }, { 'H4LOOT_GOLD_V', 953029 },
       { 'H4LOOT_PAINT_V', 714772 }, { 'H4LOOT_WEED_V', 571818 }, --
					{ 'H4_PROGRESS', 126823 }, { 'H4CNF_BS_GEN', 262143 },
       { 'H4CNF_BS_ENTR', 63 }, { 'H4CNF_BS_ABIL', 63 },
       { 'H4CNF_WEP_DISRP', 3 }, { 'H4CNF_ARM_DISRP', 3 },
       { 'H4CNF_HEL_DISRP', 3 }, { 'H4CNF_APPROACH', -1 } }
	local USER_CAN_MDFY_PRESET_AUTO_SOLO_T3 =
       ...
       { 'H4CNF_TROJAN', 5 } }
	AUTOMATED_SOLO:add_action(
					'粉钻 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #USER_CAN_MDFY_PRESET_AUTO_SOLO_T3 do
							stat_set_int(USER_CAN_MDFY_PRESET_AUTO_SOLO_T3[i][1], true,
							             USER_CAN_MDFY_PRESET_AUTO_SOLO_T3[i][2])
						end
						for i = 2, #CAYO_SOLO_AUTO_TARGET_3 do
							stat_set_int(CAYO_SOLO_AUTO_TARGET_3[i][1], true,
							             CAYO_SOLO_AUTO_TARGET_3[i][2])
						end
						globals.set_float(262145 + 29641, -0.1) -- pavel cut protection
						globals.set_float(262145 + 29642, -0.02) -- fency fee cut protection
						globals.set_int(262145 + 29395, 1800) -- bag protection
...
do
	local AUTOMATED_2P_TARGET_5 =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 16769024 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 457386 },
       { 'H4LOOT_COKE_V', 914772 }, { 'H4LOOT_GOLD_V', 1219696 },
	...
	local AUTOMATED_2P_TARGET_5_A =
       ...
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	AUTOMATED_2P:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #AUTOMATED_2P_TARGET_5_A do
							stat_set_int(AUTOMATED_2P_TARGET_5_A[i][1], true,
							             AUTOMATED_2P_TARGET_5_A[i][2])
						end
						for i = 1, #AUTOMATED_2P_TARGET_5 do
							stat_set_int(AUTOMATED_2P_TARGET_5[i][1], true,
							             AUTOMATED_2P_TARGET_5[i][2])
						end
						globals.set_float(262145 + 29641, -0.1) -- pavel cut protection
						globals.set_float(262145 + 29642, -0.02) -- fency fee cut protection
						globals.set_int(262145 + 29395, 1800) -- bag protection
...
do
	local AUTOMATED_2_TARGET_3 =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 8128 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 532386 },
       { 'H4LOOT_COKE_V', 1064772 }, { 'H4LOOT_GOLD_V', 1419696 },
       { 'H4LOOT_PAINT_V', 1064772 }, { 'H4LOOT_WEED_V', 851818 },
       { 'H4_PROGRESS', 126823 }, { 'H4CNF_BS_GEN', 262143 },
       { 'H4CNF_BS_ENTR', 63 }, { 'H4CNF_BS_ABIL', 63 },
       { 'H4CNF_WEP_DISRP', 3 }, { 'H4CNF_ARM_DISRP', 3 },
       { 'H4CNF_HEL_DISRP', 3 }, { 'H4CNF_APPROACH', -1 } }
	...
	AUTOMATED_2P:add_action(
					'粉钻 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #AUTOMATED_2_TARGET_3_A do
							stat_set_int(AUTOMATED_2_TARGET_3_A[i][1], true,
							             AUTOMATED_2_TARGET_3_A[i][2])
						end
...
do
	local AUTOMATED_3P_TARGET_5 =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 16769024 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 507034 },
       { 'H4LOOT_COKE_V', 1014069 }, { 'H4LOOT_GOLD_V', 1352091 },
	...
	local AUTOMATED_3P_TARGET_5_A =
       ...
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	AUTOMATED_3P:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #AUTOMATED_3P_TARGET_5_A do
							stat_set_int(AUTOMATED_3P_TARGET_5_A[i][1], true,
							             AUTOMATED_3P_TARGET_5_A[i][2])
						end
						for i = 1, #AUTOMATED_3P_TARGET_5 do
							stat_set_int(AUTOMATED_3P_TARGET_5[i][1], true,
							             AUTOMATED_3P_TARGET_5[i][2])
						end
						globals.set_float(262145 + 29641, -0.1) -- pavel cut protection
						globals.set_float(262145 + 29642, -0.02) -- fency fee cut protection
						globals.set_int(262145 + 29395, 1800) -- bag protection
...
do
	local AUTOMATED_3P_TARGET_3 =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 8128 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 557034 },
       { 'H4LOOT_COKE_V', 1114069 }, { 'H4LOOT_GOLD_V', 1485425 },
	...
	AUTOMATED_3P:add_action(
					'粉钻 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #AUTOMATED_3P_TARGET_3_A do
							stat_set_int(AUTOMATED_3P_TARGET_3_A[i][1], true,
							             AUTOMATED_3P_TARGET_3_A[i][2])
						end
						for i = 2, #AUTOMATED_3P_TARGET_3 do
							stat_set_int(AUTOMATED_3P_TARGET_3[i][1], true,
							             AUTOMATED_3P_TARGET_3[i][2])
						end
						globals.set_float(262145 + 29641, -0.1) -- pavel cut protection
						globals.set_float(262145 + 29642, -0.02) -- fency fee cut protection
						globals.set_int(262145 + 29395, 1800) -- bag protection
...
do
	local AUTOMATED_4P_TARGET_5 =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 16769024 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 582386 },
       { 'H4LOOT_COKE_V', 1164772 }, { 'H4LOOT_GOLD_V', 1553030 },
	...
	local AUTOMATED_4P_TARGET_5_A =
       ...
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	AUTOMATED_4P:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #AUTOMATED_4P_TARGET_5_A do
							stat_set_int(AUTOMATED_4P_TARGET_5_A[i][1], true,
							             AUTOMATED_4P_TARGET_5_A[i][2])
						end
						for i = 1, #AUTOMATED_4P_TARGET_5 do
							stat_set_int(AUTOMATED_4P_TARGET_5[i][1], true,
							             AUTOMATED_4P_TARGET_5[i][2])
						end
						globals.set_float(262145 + 29641, -0.1) -- pavel cut protection
						globals.set_float(262145 + 29642, -0.02) -- fency fee cut protection
						globals.set_int(262145 + 29395, 1800) -- bag protection
...
do
	local AUTOMATED_4P_TARGET_3 =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 8128 }, { 'H4LOOT_WEED_C', 65 },
       { 'H4LOOT_WEED_C_SCOPED', 65 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 619886 },
       { 'H4LOOT_COKE_V', 1239772 }, { 'H4LOOT_GOLD_V', 1653030 },
	...
	AUTOMATED_4P:add_action(
					'粉钻 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #AUTOMATED_4P_TARGET_3_A do
							stat_set_int(AUTOMATED_4P_TARGET_3_A[i][1], true,
							             AUTOMATED_4P_TARGET_3_A[i][2])
						end
						for i = 1, #AUTOMATED_4P_TARGET_3 do
							stat_set_int(AUTOMATED_4P_TARGET_3[i][1], true,
							             AUTOMATED_4P_TARGET_3[i][2])
						end
						globals.set_float(262145 + 29641, -0.1) -- pavel cut protection
						globals.set_float(262145 + 29642, -0.02) -- fency fee cut protection
						globals.set_int(262145 + 29395, 1800) -- bag protection
...
do
	local WKLY_SOLO_PANTHER =
					{ { 'PROSTITUTES_FREQUENTE', 100 }, -- I know horny boy, this has nothing to do with Cayo, but it is just a protection to avoid bugs
       { 'H4CNF_TARGET', 5 }, { 'H4LOOT_CASH_I', 6490148 },
       { 'H4LOOT_CASH_I_SCOPED', 6490148 }, { 'H4LOOT_CASH_C', 0 },
       { 'H4LOOT_CASH_C_SCOPED', 0 }, { 'H4LOOT_COKE_I', 8421904 },
       { 'H4LOOT_COKE_I_SCOPED', 8421904 }, { 'H4LOOT_COKE_C', 0 },
       { 'H4LOOT_COKE_C_SCOPED', 0 }, { 'H4LOOT_GOLD_I', 0 },
       { 'H4LOOT_GOLD_I_SCOPED', 0 }, { 'H4LOOT_GOLD_C', 255 },
       { 'H4LOOT_GOLD_C_SCOPED', 255 }, { 'H4LOOT_WEED_I', 1311112 },
       { 'H4LOOT_WEED_I_SCOPED', 1311112 }, { 'H4LOOT_WEED_C', 0 },
       { 'H4LOOT_WEED_C_SCOPED', 0 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 670454 },
       { 'H4LOOT_COKE_V', 1340909 }, { 'H4LOOT_GOLD_V', 1787878 },
	...
	local USER_CAN_MDFY_WKLY_SOLO_PANTHER =
       ...
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	WEEKLY_SOLO:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #USER_CAN_MDFY_WKLY_SOLO_PANTHER do
							stat_set_int(USER_CAN_MDFY_WKLY_SOLO_PANTHER[i][1], true,
							             USER_CAN_MDFY_WKLY_SOLO_PANTHER[i][2])
						end
...
do
	local WKLY_DUO_PANTHER =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 1311112 }, { 'H4LOOT_WEED_C', 0 },
       { 'H4LOOT_WEED_C_SCOPED', 0 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 920454 },
       { 'H4LOOT_COKE_V', 1840909 }, { 'H4LOOT_GOLD_V', 2454545 },
	...
	local USER_CAN_MDFY_WKLY_DUO_PANTHER =
       ...
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	WEEKLY_F2:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #USER_CAN_MDFY_WKLY_DUO_PANTHER do
							stat_set_int(USER_CAN_MDFY_WKLY_DUO_PANTHER[i][1], true,
							             USER_CAN_MDFY_WKLY_DUO_PANTHER[i][2])
						end
...
do
	local WKLY_TRIO_PANTHER =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 1311112 }, { 'H4LOOT_WEED_C', 0 },
       { 'H4LOOT_WEED_C_SCOPED', 0 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 948051 },
       { 'H4LOOT_COKE_V', 1896103 }, { 'H4LOOT_GOLD_V', 2528137 },
	...
	local USER_CAN_MDFY_WKLY_TRIO_PANTHER =
       ...
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	WEEKLY_F3:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #USER_CAN_MDFY_WKLY_TRIO_PANTHER do
							stat_set_int(USER_CAN_MDFY_WKLY_TRIO_PANTHER[i][1], true,
							             USER_CAN_MDFY_WKLY_TRIO_PANTHER[i][2])
						end
...
do
	local WKLY_FOUR_PANTHER =
       ...
       { 'H4LOOT_WEED_I_SCOPED', 1311112 }, { 'H4LOOT_WEED_C', 0 },
       { 'H4LOOT_WEED_C_SCOPED', 0 }, { 'H4LOOT_PAINT', 127 },
       { 'H4LOOT_PAINT_SCOPED', 127 }, { 'H4LOOT_CASH_V', 1045454 },
       { 'H4LOOT_COKE_V', 2090909 }, { 'H4LOOT_GOLD_V', 2787878 },
	...
	local USER_CAN_MDFY_WKLY_FOUR_PANTHER =
       ...
       { 'H4CNF_GRAPPEL', 5156 }, { 'H4_MISSIONS', -1 }, { 'H4CNF_WEAPONS', 4 },
       { 'H4CNF_TROJAN', 5 } }
	WEEKLY_F4:add_action(
					'猎豹雕像 (任意次要目标装满背包,不拿保险箱)', function()
						for i = 1, #USER_CAN_MDFY_WKLY_FOUR_PANTHER do
							stat_set_int(USER_CAN_MDFY_WKLY_FOUR_PANTHER[i][1], true,
							             USER_CAN_MDFY_WKLY_FOUR_PANTHER[i][2])
						end
...
do
	local SecondaryT_RDM = { { 'H4LOOT_CASH_I', 1319624 }, { 'H4LOOT_CASH_C', 18 },
                          { 'H4LOOT_CASH_V', 89400 },
                          { 'H4LOOT_WEED_I', 2639108 }, { 'H4LOOT_WEED_C', 36 },
                          { 'H4LOOT_WEED_V', 149000 },
                          { 'H4LOOT_COKE_I', 4229122 }, { 'H4LOOT_COKE_C', 72 },
                          { 'H4LOOT_COKE_V', 221200 },
                          { 'H4LOOT_GOLD_I', 8589313 },
                          { 'H4LOOT_GOLD_C', 129 }, { 'H4LOOT_GOLD_V', 322600 },
                          { 'H4LOOT_PAINT', 127 }, { 'H4LOOT_PAINT_V', 186800 },
...
do
	local SecondaryT_FCash = { { 'H4LOOT_CASH_I', -1 }, { 'H4LOOT_CASH_C', -1 },
                            { 'H4LOOT_CASH_V', 90000 }, { 'H4LOOT_WEED_I', 0 },
                            { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                            { 'H4LOOT_COKE_I', 0 }, { 'H4LOOT_COKE_C', 0 },
                            { 'H4LOOT_COKE_V', 0 }, { 'H4LOOT_GOLD_I', 0 },
                            { 'H4LOOT_GOLD_C', 0 }, { 'H4LOOT_GOLD_V', 0 },
                            { 'H4LOOT_PAINT', 127 },
...
do
	local SecondaryT_FWeed = { { 'H4LOOT_CASH_I', 0 }, { 'H4LOOT_CASH_C', 0 },
                            { 'H4LOOT_CASH_V', 0 }, { 'H4LOOT_WEED_I', -1 },
                            { 'H4LOOT_WEED_C', -1 },
                            { 'H4LOOT_WEED_V', 140000 }, { 'H4LOOT_COKE_I', 0 },
                            { 'H4LOOT_COKE_C', 0 }, { 'H4LOOT_COKE_V', 0 },
                            { 'H4LOOT_GOLD_I', 0 }, { 'H4LOOT_GOLD_C', 0 },
                            { 'H4LOOT_GOLD_V', 0 }, { 'H4LOOT_PAINT', 127 },
                            { 'H4LOOT_PAINT_V', 190000 },
...
do
	local SecondaryT_FCoke = { { 'H4LOOT_CASH_I', 0 }, { 'H4LOOT_CASH_C', 0 },
                            { 'H4LOOT_CASH_V', 0 }, { 'H4LOOT_WEED_I', 0 },
                            { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                            { 'H4LOOT_COKE_I', -1 }, { 'H4LOOT_COKE_C', -1 },
                            { 'H4LOOT_COKE_V', 210000 }, { 'H4LOOT_GOLD_I', 0 },
                            { 'H4LOOT_GOLD_C', 0 }, { 'H4LOOT_GOLD_V', 0 },
                            { 'H4LOOT_PAINT', 127 },
                            { 'H4LOOT_PAINT_V', 190000 },
                            { 'H4LOOT_CASH_I_SCOPED', 0 },
...
do
	local SecondaryT_FGold = { { 'H4LOOT_CASH_I', 0 }, { 'H4LOOT_CASH_C', 0 },
                            { 'H4LOOT_CASH_V', 0 }, { 'H4LOOT_WEED_I', 0 },
                            { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                            { 'H4LOOT_COKE_I', 0 }, { 'H4LOOT_COKE_C', 0 },
                            { 'H4LOOT_COKE_V', 0 }, { 'H4LOOT_GOLD_I', -1 },
                            { 'H4LOOT_GOLD_C', -1 },
                            { 'H4LOOT_GOLD_V', 320000 }, { 'H4LOOT_PAINT', -1 },
                            { 'H4LOOT_PAINT_V', 190000 },
                            { 'H4LOOT_CASH_I_SCOPED', 0 },
                            { 'H4LOOT_CASH_C_SCOPED', 0 },
                            { 'H4LOOT_WEED_I_SCOPED', 0 },
...
do
	local SecondaryT_Remove = { { 'H4LOOT_CASH_I', 0 }, { 'H4LOOT_CASH_C', 0 },
                             { 'H4LOOT_CASH_V', 0 }, { 'H4LOOT_WEED_I', 0 },
                             { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                             { 'H4LOOT_COKE_I', 0 }, { 'H4LOOT_COKE_C', 0 },
                             { 'H4LOOT_COKE_V', 0 }, { 'H4LOOT_GOLD_I', 0 },
                             { 'H4LOOT_GOLD_C', 0 }, { 'H4LOOT_GOLD_V', 0 },
                             { 'H4LOOT_PAINT', 0 }, { 'H4LOOT_PAINT_V', 0 },
                             { 'H4LOOT_CASH_I_SCOPED', 0 },
                             { 'H4LOOT_CASH_C_SCOPED', 0 },
                             { 'H4LOOT_WEED_I_SCOPED', 0 },
                             { 'H4LOOT_WEED_C_SCOPED', 0 },
...
do
	local Compound_LT_MIX = { { 'H4LOOT_CASH_C', 2 }, { 'H4LOOT_CASH_V', 474431 },
                           { 'H4LOOT_WEED_C', 17 }, { 'H4LOOT_WEED_V', 759090 },
                           { 'H4LOOT_COKE_C', 132 },
...
do
	local Compound_LT_CASH = { { 'H4LOOT_CASH_C', -1 }, { 'H4LOOT_CASH_V', 90000 },
                            { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                            { 'H4LOOT_COKE_C', 0 }, { 'H4LOOT_COKE_V', 0 },
                            { 'H4LOOT_GOLD_C', 0 }, { 'H4LOOT_GOLD_V', 0 },
                            { 'H4LOOT_PAINT', 127 },
...
do
	local Compound_LT_WEED = { { 'H4LOOT_CASH_C', 0 }, { 'H4LOOT_CASH_V', 0 },
                            { 'H4LOOT_WEED_C', -1 },
                            { 'H4LOOT_WEED_V', 140000 }, { 'H4LOOT_COKE_C', 0 },
                            { 'H4LOOT_COKE_V', 0 }, { 'H4LOOT_GOLD_C', 0 },
                            { 'H4LOOT_PAINT', 127 },
                            { 'H4LOOT_PAINT_V', 190000 },
                            { 'H4LOOT_CASH_C_SCOPED', 0 },
                            { 'H4LOOT_WEED_C_SCOPED', -1 },
...
do
	local Compound_LT_COKE = { { 'H4LOOT_CASH_C', 0 }, { 'H4LOOT_CASH_V', 0 },
                            { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                            { 'H4LOOT_COKE_C', -1 },
                            { 'H4LOOT_COKE_V', 210000 }, { 'H4LOOT_GOLD_C', 0 },
                            { 'H4LOOT_PAINT', 127 },
                            { 'H4LOOT_PAINT_V', 190000 },
                            { 'H4LOOT_CASH_C_SCOPED', 0 },
                            { 'H4LOOT_WEED_C_SCOPED', 0 },
...
do
	local Compound_LT_GOLD = { { 'H4LOOT_CASH_C', 0 }, { 'H4LOOT_CASH_V', 0 },
                            { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                            { 'H4LOOT_COKE_C', 0 }, { 'H4LOOT_COKE_V', 0 },
                            { 'H4LOOT_GOLD_C', -1 },
...
do
	local Compound_LT_PAINT = { { 'H4LOOT_CASH_C', 0 }, { 'H4LOOT_CASH_V', 0 },
                             { 'H4LOOT_WEED_C', 0 }, { 'H4LOOT_WEED_V', 0 },
                             { 'H4LOOT_COKE_C', 0 }, { 'H4LOOT_COKE_V', 0 },
                             { 'H4LOOT_GOLD_C', 0 }, { 'H4LOOT_GOLD_V', 0 },
                             { 'H4LOOT_GOLD_C_SCOPED', 0 },
...
do
	local Remove_Compound_Paint = { { 'H4LOOT_PAINT', 0 }, { 'H4LOOT_PAINT_V', 0 },
                                 { 'H4LOOT_PAINT_SCOPED', 0 } }
...
do
	local Remove_ALL_Compound_LT = { { 'H4LOOT_CASH_C', 0 },
                                  { 'H4LOOT_WEED_C', 0 },
                                  { 'H4LOOT_COKE_C', 0 },
                                  { 'H4LOOT_GOLD_C', 0 },
                                  { 'H4LOOT_GOLD_C_SCOPED', 0 },
...
do
	local CP_Item_SpawnPlace_AIR = { { 'H4CNF_GRAPPEL', 2022 },
                                  { 'H4CNF_UNIFORM', 12 },
                                  { 'H4CNF_BOLTCUT', 4161 },
                                  { 'H4CNF_TROJAN', 1 } }
...
do
	local CP_Item_SpawnPlace_DKS = { { 'H4CNF_GRAPPEL', 3671 },
                                  { 'H4CNF_UNIFORM', 5256 },
                                  { 'H4CNF_BOLTCUT', 4424 },
                                  { 'H4CNF_TROJAN', 2 } }
...
do
	local CP_Item_SpawnPlace_CP = { { 'H4CNF_GRAPPEL', 85324 },
                                 { 'H4CNF_UNIFORM', 61034 },
                                 { 'H4CNF_BOLTCUT', 4612 },
                                 { 'H4CNF_TROJAN', 5 } }
...
do
	MORE_OPTIONS:add_action('解锁佩里科岛奖励', function()
		local CP_AWRD_BL = { { 'AWD_INTELGATHER', true },
                       { 'AWD_COMPOUNDINFILT', true },
                       { 'AWD_LOOT_FINDER', true }, { 'AWD_MAX_DISRUPT', true },
                       { 'AWD_THE_ISLAND_HEIST', true },
                       { 'AWD_GOING_ALONE', true }, { 'AWD_TEAM_WORK', true },
                       { 'AWD_MIXING_UP', true }, { 'AWD_PRO_THIEF', true },
                       { 'AWD_CAT_BURGLAR', true }, { 'AWD_ONE_OF_THEM', true },
                       { 'AWD_GOLDEN_GUN', true }, { 'AWD_ELITE_THIEF', true },
                       { 'AWD_PROFESSIONAL', true },
                       { 'AWD_HELPING_OUT', true }, { 'AWD_COURIER', true },
		...
		local CP_AWRD_IT = { { 'AWD_LOSTANDFOUND', 500000 },
                       { 'AWD_SUNSET', 1800000 },
                       ...
                       { 'AWD_WELL_PREPARED', 80 }, { 'H4_H4_DJ_MISSIONS', -1 } }
...
do
	local COMPLETE_CP_MISSIONS =
					{ { 'PROSTITUTES_FREQUENTE', 100 }, -- I know horny boy, this has nothing to do with Cayo, but it is just a protection to avoid bugs
       { 'H4_MISSIONS', -1 }, { 'H4CNF_APPROACH', -1 }, { 'H4CNF_BS_ENTR', 63 },
       { 'H4CNF_BS_GEN', 63 }, { 'H4CNF_WEP_DISRP', 3 },
       { 'H4CNF_ARM_DISRP', 3 }, { 'H4CNF_HEL_DISRP', 3 } }
...
do
	local CP_RST = { { 'H4_MISSIONS', 0 }, { 'H4_PROGRESS', 0 },
                  { 'H4CNF_APPROACH', 0 }, { 'H4CNF_BS_ENTR', 0 },
...
-- 名钻赌场抢劫
do
	local RunOnce = { { 'H3_COMPLETEDPOSIX', -1 }, { 'H3OPT_MASKS', 4 },
                   { 'H3OPT_WEAPS', 1 }, { 'H3OPT_VEHS', 3 } }
	local CAH_SILENT_SNEAKY_PRESET_ID_DMND =
					{ { 'CAS_HEIST_FLOW', -1 }, { 'H3_LAST_APPROACH', 0 },
       { 'H3OPT_APPROACH', 1 }, { 'H3_HARD_APPROACH', 0 },
       { 'H3OPT_TARGET', 3 }, { 'H3OPT_POI', 1023 },
       { 'H3OPT_ACCESSPOINTS', 2047 }, { 'H3OPT_CREWWEAP', 4 },
       { 'H3OPT_CREWDRIVER', 3 }, { 'H3OPT_CREWHACKER', 4 },
       { 'H3OPT_DISRUPTSHIP', 3 }, { 'H3OPT_BODYARMORLVL', -1 },
       { 'H3OPT_KEYLEVELS', 2 }, { 'H3OPT_BITSET1', 127 },
       { 'H3OPT_BITSET0', 262270 } }
	CAH_DIA_TARGET:add_action('隐迹潜踪 (钻石,请选择低级买家)',
	                          function()
		for i = 1, #RunOnce do
			stat_set_int(RunOnce[i][1], true, RunOnce[i][2])
		end
		for i = 1, #CAH_SILENT_SNEAKY_PRESET_ID_DMND do
			stat_set_int(CAH_SILENT_SNEAKY_PRESET_ID_DMND[i][1], true,
			             CAH_SILENT_SNEAKY_PRESET_ID_DMND[i][2])
		end
...
do
	local RunOnce = { { 'H3_COMPLETEDPOSIX', -1 }, { 'H3OPT_MASKS', 2 },
                   { 'H3OPT_WEAPS', 1 }, { 'H3OPT_VEHS', 3 } }
	local CAH_BIGCON_PRESET_ID_DMND = { { 'CAS_HEIST_FLOW', -1 },
                                     { 'H3_LAST_APPROACH', 0 },
                                     { 'H3OPT_APPROACH', 2 },
                                     { 'H3_HARD_APPROACH', 0 },
                                     { 'H3OPT_TARGET', 3 },
	...
	CAH_DIA_TARGET:add_action('兵不厌诈 (钻石,请选择低级买家)',
	                          function()
		for i = 1, #RunOnce do
			stat_set_int(RunOnce[i][1], true, RunOnce[i][2])
		end
		for i = 1, #CAH_BIGCON_PRESET_ID_DMND do
			stat_set_int(CAH_BIGCON_PRESET_ID_DMND[i][1], true,
			             CAH_BIGCON_PRESET_ID_DMND[i][2])
		end
		globals.set_int(1966739 + 2326, 60) -- [Diamond] 60% Low | 57 Medium | High 54
		globals.set_int(1966739 + 2326 + 1, 147) -- Low Buyer: 147 | Medium: 140 | High Buyer: 133
		globals.set_int(1966739 + 2326 + 2, 147)
...
do
	local RunOnce = { { 'H3_COMPLETEDPOSIX', -1 }, { 'H3OPT_MASKS', 4 },
                   { 'H3OPT_WEAPS', 1 }, { 'H3OPT_VEHS', 3 } }
	local CAH_AGGRESS_PRESET_ID_DMND = { { 'CAS_HEIST_FLOW', -1 },
                                      { 'H3_LAST_APPROACH', 0 },
                                      { 'H3OPT_APPROACH', 3 },
                                      { 'H3_HARD_APPROACH', 0 },
                                      { 'H3OPT_TARGET', 3 },
	...
	CAH_DIA_TARGET:add_action('气势汹汹 (钻石,请选择低级买家)',
	                          function()
		for i = 1, #RunOnce do
			stat_set_int(RunOnce[i][1], true, RunOnce[i][2])
		end
		for i = 1, #CAH_AGGRESS_PRESET_ID_DMND do
			stat_set_int(CAH_AGGRESS_PRESET_ID_DMND[i][1], true,
			             CAH_AGGRESS_PRESET_ID_DMND[i][2])
		end
		globals.set_int(1966739 + 2326, 60) -- [Diamond] 60% Low | 57 Medium | High 54
		globals.set_int(1966739 + 2326 + 1, 147) -- Low Buyer: 147 | Medium: 140 | High Buyer: 133
		globals.set_int(1966739 + 2326 + 2, 147)
...
do
	local RunOnce = { { 'H3_COMPLETEDPOSIX', -1 }, { 'H3OPT_MASKS', 4 },
                   { 'H3OPT_WEAPS', 1 }, { 'H3OPT_VEHS', 3 } }
	local CAH_SILENT_GOLD_PRESET = { { 'CAS_HEIST_FLOW', -1 },
                                  { 'H3_LAST_APPROACH', 0 },
                                  { 'H3OPT_APPROACH', 1 },
                                  { 'H3_HARD_APPROACH', 0 },
                                  { 'H3OPT_TARGET', 1 }, { 'H3OPT_POI', 1023 },
                                  { 'H3OPT_ACCESSPOINTS', 2047 },
                                  { 'H3OPT_CREWWEAP', 4 },
                                  { 'H3OPT_CREWDRIVER', 3 },
                                  { 'H3OPT_CREWHACKER', 4 },
                                  ...
                                  { 'H3OPT_BITSET1', 127 },
                                  { 'H3OPT_BITSET0', 262270 } }
	CAH_GOLD_TARGET:add_action('隐迹潜踪 (黄金,请选择低级买家)',
	                           function()
		for i = 1, #RunOnce do
			stat_set_int(RunOnce[i][1], true, RunOnce[i][2])
		end
...
do
	local RunOnce = { { 'H3_COMPLETEDPOSIX', -1 }, { 'H3OPT_MASKS', 4 },
                   { 'H3OPT_WEAPS', 1 }, { 'H3OPT_VEHS', 3 } }
	local CAH_BIGCON_GOLD_PRESET = { { 'CAS_HEIST_FLOW', -1 },
                                  { 'H3_LAST_APPROACH', 0 },
                                  { 'H3OPT_APPROACH', 2 },
                                  { 'H3_HARD_APPROACH', 0 },
                                  { 'H3OPT_TARGET', 1 }, { 'H3OPT_POI', 1023 },
                                  ...
                                  { 'H3OPT_BITSET1', 159 },
                                  { 'H3OPT_BITSET0', 524118 } }
	CAH_GOLD_TARGET:add_action('兵不厌诈 (黄金,请选择低级买家)',
	                           function()
		for i = 1, #RunOnce do
			stat_set_int(RunOnce[i][1], true, RunOnce[i][2])
		end
...
do
	local RunOnce = { { 'H3_COMPLETEDPOSIX', -1 }, { 'H3OPT_MASKS', 4 },
                   { 'H3OPT_WEAPS', 1 }, { 'H3OPT_VEHS', 3 } }
	local CAH_AGGRESSIV_GOLD_PRESET = { { 'CAS_HEIST_FLOW', -1 },
                                     { 'H3OPT_APPROACH', 3 },
                                     { 'H3OPT_TARGET', 1 },
                                     { 'H3OPT_POI', 1023 },
                                     { 'H3OPT_ACCESSPOINTS', 2047 },
                                     ...
                                     { 'H3_LAST_APPROACH', 0 },
                                     { 'H3_HARD_APPROACH', 0 } }
	CAH_GOLD_TARGET:add_action('气势汹汹 (黄金,请选择低级买家)',
	                           function()
		for i = 1, #RunOnce do
			stat_set_int(RunOnce[i][1], true, RunOnce[i][2])
		end
		for i = 1, #CAH_AGGRESSIV_GOLD_PRESET do
			stat_set_int(CAH_AGGRESSIV_GOLD_PRESET[i][1], true,
			             CAH_AGGRESSIV_GOLD_PRESET[i][2])
		end
		globals.set_int(1966739 + 2326, 60) -- [Gold] 60% Low | 57 Medium | High 54
		globals.set_int(1966739 + 2326 + 1, 178) -- [Gold] 178% Low | 169 Medium | 161 High
		globals.set_int(1966739 + 2326 + 2, 178)
...
do
	local CAH_NON_HOSTCUT = CAH_PLAYER_CUT:add_submenu(
					                        '你的分红 (不是房主是使用)')
	-- [unuseable]需要用户输入
...
do
	local CAH_PLAYER_HOST = CAH_PLAYER_CUT:add_submenu(
					                        '你的分红 (作为房主时使用)')
	-- [unuseable]需要用户输入
...
--- CASINO DIFFICULTY
do
	local CH_Diff_Hard1 = { { 'H3_LAST_APPROACH', 0 }, { 'H3OPT_APPROACH', 1 },
                         { 'H3_HARD_APPROACH', 1 } }
...
do
	local CH_Diff_Normal1 = { { 'H3_LAST_APPROACH', 0 }, { 'H3OPT_APPROACH', 1 },
                           { 'H3_HARD_APPROACH', 0 } }
...
do
	local CH_Diff_Hard2 = { { 'H3_LAST_APPROACH', 0 }, { 'H3OPT_APPROACH', 2 },
                         { 'H3_HARD_APPROACH', 2 } }
...
do
	local CH_Diff_Normal2 = { { 'H3_LAST_APPROACH', 0 }, { 'H3OPT_APPROACH', 2 },
                           { 'H3_HARD_APPROACH', 0 } }
...
do
	local CH_Diff_Hard3 = { { 'H3_LAST_APPROACH', 0 }, { 'H3OPT_APPROACH', 3 },
                         { 'H3_HARD_APPROACH', 0 } }
...
do
	local CH_Diff_Normal3 = { { 'H3_LAST_APPROACH', 0 }, { 'H3OPT_APPROACH', 3 },
                           { 'H3_HARD_APPROACH', 0 } }
...
do
	...
	CASINO_GUNMAN:add_action('随机枪手 (??%)', function()
		for i = 1, #CH_GUNMAN_RND do
			stat_set_int(CH_GUNMAN_RND[i][1], true,
			             math.random(CH_GUNMAN_RND[i][4], CH_GUNMAN_RND[i][5]))
		end
	end)
end
do
...
do
	...
	CASINO_DRIVER_TEAM:add_action('随机车手 (??%)', function()
		for i = 1, #CH_DRV_MAN_RND do
			stat_set_int(CH_DRV_MAN_RND[i][1], true,
			             math.random(CH_DRV_MAN_RND[i][4], CH_DRV_MAN_RND[i][5]))
		end
	end)
end
do
...
do
	...
	CAH_DRIVER_TEAM_var:add_action('随机载具选择', function()
		for i = 1, #CH_DRV_MAN_var_RND do
			stat_set_int(CH_DRV_MAN_var_RND[i][1], true,
			             math.random(CH_DRV_MAN_var_RND[i][4], CH_DRV_MAN_var_RND[i][5]))
		end
	end)
end
...
do
	...
	CASINO_HACKERs:add_action('随机黑客 (??%)', function()
		for i = 1, #CH_HCK_MAN_RND do
			stat_set_int(CH_HCK_MAN_RND[i][1], true,
			             math.random(CH_HCK_MAN_RND[i][4], CH_HCK_MAN_RND[i][5]))
		end
	end)
end
do
...
do
	...
	CASINO_BOARD3:add_action('移除电钻 (兵不厌诈)', function()
		for i = 1, #CH_UNLCK_3stboard_var3bc do
			stat_set_int(CH_UNLCK_3stboard_var3bc[i][1], true,
			             CH_UNLCK_3stboard_var3bc[i][2])
		end
	end)
end
do
...
do
	local CLD_CH_RMV = { { 'MPPLY_H3_COOLDOWN', 0xFFFFFFF },
...
do
	local CH_AWRD_BL = { { 'AWD_FIRST_TIME1', true }, { 'AWD_FIRST_TIME2', true },
                      { 'AWD_FIRST_TIME3', true }, { 'AWD_FIRST_TIME4', true },
                      { 'AWD_FIRST_TIME5', true }, { 'AWD_FIRST_TIME6', true },
                      { 'AWD_ALL_IN_ORDER', true },
                      { 'AWD_SUPPORTING_ROLE', true }, { 'AWD_LEADER', true },
                      { 'AWD_ODD_JOBS', true }, { 'AWD_SURVIVALIST', true },
                      { 'AWD_SCOPEOUT', true }, { 'AWD_CREWEDUP', true },
                      { 'AWD_MOVINGON', true }, { 'AWD_PROMOCAMP', true },
                      { 'AWD_GUNMAN', true }, { 'AWD_SMASHNGRAB', true },
                      { 'AWD_INPLAINSI', true }, { 'AWD_UNDETECTED', true },
                      { 'AWD_ALLROUND', true }, { 'AWD_ELITETHEIF', true },
                      { 'AWD_PRO', true }, { 'AWD_SUPPORTACT', true },
                      { 'AWD_SHAFTED', true }, { 'AWD_COLLECTOR', true },
                      { 'AWD_DEADEYE', true }, { 'AWD_PISTOLSATDAWN', true },
                      { 'AWD_TRAFFICAVOI', true }, { 'AWD_CANTCATCHBRA', true },
                      { 'AWD_WIZHARD', true }, { 'AWD_APEESCAPE', true },
                      { 'AWD_MONKEYKIND', true }, { 'AWD_AQUAAPE', true },
                      { 'AWD_KEEPFAITH', true }, { 'AWD_TRUELOVE', true },
                      { 'AWD_NEMESIS', true }, { 'AWD_FRIENDZONED', true },
                      ...
                      { 'CAS_VEHICLE_REWARD', false }, { 'HELP_FURIA', true },
                      { 'HELP_MINITAN', true }, { 'HELP_YOSEMITE2', true },
                      { 'HELP_ZHABA', true }, { 'HELP_IMORGEN', true },
                      { 'HELP_SULTAN2', true }, { 'HELP_VAGRANT', true },
                      { 'HELP_VSTR', true }, { 'HELP_STRYDER', true },
                      { 'HELP_SUGOI', true }, { 'HELP_KANJO', true },
                      { 'HELP_FORMULA', true }, { 'HELP_FORMULA2', true },
                      { 'HELP_JB7002', true } }
	local CH_AWRD_IT = { { 'ARCADE_MAC_0', -1 }, { 'ARCADE_MAC_1', -1 },
                      { 'ARCADE_MAC_2', -1 }, { 'ARCADE_MAC_3', -1 },
                      { 'ARCADE_MAC_4', -1 }, { 'ARCADE_MAC_5', -1 },
                      { 'ARCADE_MAC_6', -1 }, { 'ARCADE_MAC_7', -1 },
                      { 'ARCADE_MAC_8', -1 }, { 'ARCADE_MAC_9', -1 },
                      { 'ARCADE_MAC_10', -1 }, { 'ARCADE_MAC_11', -1 },
                      { 'ARCADE_MAC_12', -1 }, { 'ARCADE_MAC_13', -1 },
                      { 'ARCADE_MAC_14', -1 }, { 'ARCADE_MAC_15', -1 },
                      { 'CAS_HEIST_NOTS', -1 }, { 'CAS_HEIST_FLOW', -1 },
                      { 'CH_ARC_CAB_CLAW_TROPHY', -1 },
                      { 'CH_ARC_CAB_LOVE_TROPHY', -1 },
                      { 'SIGNAL_JAMMERS_COLLECTED', 50 },
                      { 'AWD_ODD_JOBS', 52 }, { 'AWD_PREPARATION', 40 },
                      { 'AWD_ASLEEPONJOB', 20 }, { 'AWD_DAICASHCRAB', 100000 },
                      { 'AWD_BIGBRO', 40 }, { 'AWD_SHARPSHOOTER', 40 },
                      { 'AWD_RACECHAMP', 40 }, { 'AWD_BATSWORD', 1000000 },
                      { 'AWD_COINPURSE', 950000 },
                      { 'AWD_ASTROCHIMP', 3000000 }, { 'AWD_MASTERFUL', 40000 },
                      { 'H3_BOARD_DIALOGUE0', -1 },
                      { 'H3_BOARD_DIALOGUE1', -1 },
                      { 'H3_BOARD_DIALOGUE2', -1 }, { 'H3_VEHICLESUSED', -1 },
                      { 'H3_CR_STEALTH_1A', 100 },
                      { 'H3_CR_STEALTH_2B_RAPP', 100 },
                      { 'H3_CR_STEALTH_2C_SIDE', 100 },
                      { 'H3_CR_STEALTH_3A', 100 }, { 'H3_CR_STEALTH_4A', 100 },
                      ...
                      { 'H3_CR_DIRECT_1A', 100 }, { 'H3_CR_DIRECT_2A1', 100 },
                      { 'H3_CR_DIRECT_2A2', 100 }, { 'H3_CR_DIRECT_2BP', 100 },
                      { 'H3_CR_DIRECT_2C', 100 }, { 'H3_CR_DIRECT_3A', 100 },
                      { 'H3_CR_DIRECT_4A', 100 }, { 'H3_CR_DIRECT_5A', 100 },
                      { 'CR_ORDER', 100 } }
...
do
	local AGATHA_MS_INT = { { 'VCM_FLOW_PROGRESS', -1 },
                         { 'VCM_STORY_PROGRESS', 5 } }
	local AGATHA_MS_BOL = { { 'AWD_LEADER', true },
                         { 'VCM_FLOW_CS_FIN_SEEN', true } }
...
do
	local CH_RST = { { 'H3_LAST_APPROACH', 0 }, { 'H3OPT_APPROACH', 0 },
                  { 'H3_HARD_APPROACH', 0 }, { 'H3OPT_TARGET', 0 },
                  { 'H3OPT_POI', 0 }, { 'H3OPT_ACCESSPOINTS', 0 },
                  { 'H3OPT_BITSET1', 0 }, { 'H3OPT_CREWWEAP', 0 },
                  { 'H3OPT_CREWDRIVER', 0 }, { 'H3OPT_CREWHACKER', 0 },
                  { 'H3OPT_WEAPS', 0 }, { 'H3OPT_VEHS', 0 },
                  { 'H3OPT_DISRUPTSHIP', 0 }, { 'H3OPT_BODYARMORLVL', 0 },
                  { 'H3OPT_KEYLEVELS', 0 }, { 'H3OPT_MASKS', 0 },
                  { 'H3OPT_BITSET0', 0 } }
...
-------- DOOMSDAY HEIST
do
	local DD_H_ACT1 = { { 'GANGOPS_FLOW_MISSION_PROG', 503 },
...
do
	local DD_H_ACT2 = { { 'GANGOPS_FLOW_MISSION_PROG', 240 },
                     { 'GANGOPS_HEIST_STATUS', -229378 },
                     { 'GANGOPS_FLOW_NOTIFICATIONS', 1557 } }
	DOOMS_PRESETS:add_action('末日二 : 波格丹危机 $250w 1-4 人',
	                         function()
...
do
	local DD_H_ACT3 = { { 'GANGOPS_FLOW_MISSION_PROG', 16368 },
...
do
	local DDHEIST_HOST_MANAGER =
					DDHEIST_PLYR_MANAGER:add_submenu('玩家 1 分红')
	-- [unuseable]需要用户输入
...
do
	local DDHEIST_PLAYER2_MANAGER = DDHEIST_PLYR_MANAGER:add_submenu(
					                                '玩家 2 分红')
	-- [unuseable]需要用户输入
...
do
	local DDHEIST_PLAYER3_MANAGER = DDHEIST_PLYR_MANAGER:add_submenu(
					                                '玩家 3 分红')
	-- [unuseable]需要用户输入
...
do
	local DDHEIST_PLAYER4_MANAGER = DDHEIST_PLYR_MANAGER:add_submenu(
					                                '玩家 4 分红')
	-- [unuseable]需要用户输入
...
do
	local DD_H_ULCK = { { 'GANGOPS_HEIST_STATUS', -1 },
                     { 'GANGOPS_HEIST_STATUS', -229384 } }
	DOOMS_HEIST:add_action(
					'解锁全部末日抢劫 (给莱斯特打电话取消末日抢劫三次)',
					function()
...
do
	local DD_H_RST = { { 'GANGOPS_FLOW_MISSION_PROG', 240 },
...
do
	local DD_AWARDS_I = { { 'GANGOPS_FM_MISSION_PROG', -1 },
                       { 'GANGOPS_FLOW_MISSION_PROG', -1 },
                       { 'MPPLY_GANGOPS_ALLINORDER', 536870911 },
                       { 'MPPLY_GANGOPS_LOYALTY', 536870911 },
                       { 'MPPLY_GANGOPS_CRIMMASMD', 536870911 },
                       { 'MPPLY_GANGOPS_LOYALTY2', 536870911 },
                       { 'MPPLY_GANGOPS_LOYALTY3', 536870911 },
                       { 'MPPLY_GANGOPS_CRIMMASMD2', 536870911 },
                       { 'MPPLY_GANGOPS_CRIMMASMD3', 536870911 },
                       { 'MPPLY_GANGOPS_SUPPORT', 536870911 },
                       { 'CR_GANGOP_MORGUE', 10 }, { 'CR_GANGOP_DELUXO', 10 },
                       { 'CR_GANGOP_SERVERFARM', 10 },
                       { 'CR_GANGOP_IAABASE_FIN', 10 },
                       { 'CR_GANGOP_STEALOSPREY', 10 },
                       { 'CR_GANGOP_FOUNDRY', 10 }, { 'CR_GANGOP_RIOTVAN', 10 },
...
do
	local Apartment_AWD_B = { { 'MPPLY_AWD_COMPLET_HEIST_MEM', true },
	...
	local Apartment_AWD_I = { { 'AWD_FINISH_HEISTS', 900 },
                           ...
                           { 'CR_NARC_BIKERS', 5000 }, { 'CR_NARC_WEED', 5000 },
...
CLASSIC_HEISTS:add_action('全福银行 1500w (作为房主时使用)',
                          function()
	globals.set_int(1934636 + 3008 + 1, 10434)
end)
CLASSIC_HEISTS:add_action('全福银行 1000w (作为房主时使用)',
                          function()
	globals.set_int(1934636 + 3008 + 1, 7000)
end)
CLASSIC_HEISTS:add_action('全福银行 500w (作为房主时使用)',
                          function()
	globals.set_int(1934636 + 3008 + 1, 3500)
end)
-- CLASSIC CUT WEEKLY EVENT
CLASSIC_HEISTS:add_action('[2x] 全福银行 1500w (作为房主时使用)',
                          function()
	globals.set_int(1934636 + 3008 + 1, 5217)
end)
CLASSIC_HEISTS:add_action('[2x] 全福银行 1000w (作为房主时使用)',
                          function()
	globals.set_int(1934636 + 3008 + 1, 3500)
end)
CLASSIC_HEISTS:add_action('[2x] 全福银行 500w (作为房主时使用)',
                          function()
...
do
	local LS_CONTRACT_4_PRSN =
					{ { 'TUNER_GEN_BS', 12543 }, { 'TUNER_CURRENT', 4 } }
...
do
	local LS_CONTRACT_6_LOST =
					{ { 'TUNER_GEN_BS', 12543 }, { 'TUNER_CURRENT', 6 } }
...
do
	local LS_CONTRACT_7_DATA =
					{ { 'TUNER_GEN_BS', 12543 }, { 'TUNER_CURRENT', 7 } }
...
do
	local LS_TUNERS_DLC_BL = { { 'AWD_CAR_CLUB', true },
                            ...
                            { 'AWD_IAA_RAID', true }, { 'AWD_METH_JOB', true },
                            { 'AWD_BUNKER_RAID', true },
                            { 'AWD_STRAIGHT_TO_VIDEO', true },
                            { 'AWD_MONKEY_C_MONKEY_DO', true },
                            { 'AWD_TRAINED_TO_KILL', true },
                            { 'AWD_DIRECTOR', true } }
	local LS_TUNERS_DLC_IT = { { 'AWD_CAR_CLUB_MEM', 100 },
                            { 'AWD_SPRINTRACER', 50 },
                            { 'AWD_STREETRACER', 50 },
                            { 'AWD_PURSUITRACER', 50 }, { 'AWD_TEST_CAR', 240 },
                            { 'AWD_AUTO_SHOP', 50 }, { 'AWD_CAR_EXPORT', 100 },
                            { 'AWD_GROUNDWORK', 40 },
...
do
	...
	ROBBERY_RESETER:add_action('重置任务', function()
		for i = 1, #LS_CONTRACT_MISSION_RST do
			stat_set_int(LS_CONTRACT_MISSION_RST[i][1], true,
			             LS_CONTRACT_MISSION_RST[i][2])
		end
	end)
end
do
...
do
	...
	ROBBERY_RESETER:add_action('重置合约任务收入和完成次数',
	                           function()
...
do
	local LEAK_NIGHTCLUB = { { 'FIXER_GENERAL_BS', -1 },
                          { 'FIXER_COMPLETED_BS', -1 }, { 'FIXER_STORY_BS', 3 },
...
do
	local LEAK_MARINA = { { 'FIXER_GENERAL_BS', -1 }, { 'FIXER_COMPLETED_BS', -1 },
                       { 'FIXER_STORY_BS', 4 }, { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local LEAK_NIGHTLIFE = { { 'FIXER_GENERAL_BS', -1 },
...
do
	local LEAK_COUNTRYCLUB = { { 'FIXER_GENERAL_BS', -1 },
                            { 'FIXER_COMPLETED_BS', -1 },
...
do
	local LEAK_GUESTLIST = { { 'FIXER_GENERAL_BS', -1 },
                          { 'FIXER_COMPLETED_BS', -1 },
                          { 'FIXER_STORY_STRAND', -1 },
                          { 'FIXER_STORY_BS', 60 },
                          { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local LEAK_HIGHSOCIETY = { { 'FIXER_GENERAL_BS', -1 },
                            { 'FIXER_COMPLETED_BS', -1 },
                            { 'FIXER_STORY_STRAND', -1 },
                            { 'FIXER_STORY_BS', 124 },
                            { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local LEAK_DAVIS = { { 'FIXER_GENERAL_BS', -1 }, { 'FIXER_COMPLETED_BS', -1 },
                      { 'FIXER_STORY_STRAND', -1 }, { 'FIXER_STORY_BS', 252 },
                      { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local LEAK_BALLAS = { { 'FIXER_GENERAL_BS', -1 }, { 'FIXER_COMPLETED_BS', -1 },
                       { 'FIXER_STORY_STRAND', -1 }, { 'FIXER_STORY_BS', 508 },
                       { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local LEAK_STUDIO = { { 'FIXER_GENERAL_BS', -1 }, { 'FIXER_COMPLETED_BS', -1 },
                       { 'FIXER_STORY_STRAND', -1 }, { 'FIXER_STORY_BS', 2044 },
                       { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local LEAK_FINAL = { { 'FIXER_GENERAL_BS', -1 }, { 'FIXER_COMPLETED_BS', -1 },
                      { 'FIXER_STORY_STRAND', -1 }, { 'FIXER_STORY_BS', 4092 },
                      { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local CONTRACT_COMPLETE = { { 'FIXER_GENERAL_BS', -1 },
                             { 'FIXER_COMPLETED_BS', -1 },
                             { 'FIXER_STORY_BS', -1 },
                             { 'FIXER_STORY_COOLDOWN', -1 } }
...
do
	local TH_AWARDS_I = { { 'AWD_CONTRACTOR', 50 }, { 'AWD_COLD_CALLER', 50 },
                       { 'AWD_PRODUCER', 60 },
	...
	local TH_AWARDS_B = { { 'AWD_TEEING_OFF', true }, { 'AWD_PARTY_NIGHT', true },
                       { 'AWD_BILLIONAIRE_GAMES', true },
                       { 'AWD_HOOD_PASS', true }, { 'AWD_STUDIO_TOUR', true },
                       { 'AWD_DONT_MESS_DRE', true }, { 'AWD_BACKUP', true },
